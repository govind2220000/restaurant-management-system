  ...
  return (
    <>
      <div className="profile-section">
        <Tooltip text="Admin Profile" position="right">
      ...
      <div className="sidebar">
        <div className="sidebar-content">
          ...
          <Tooltip text="Tables & Seats" position="right">
            <NavLink
              to="/admin/seats"
              className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}
              end
          ...
          <Tooltip text="Order Management" position="right">
            <NavLink
              to="/admin/order-line"
              className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}
              end
          ...
          <Tooltip text="Analytics & Reports" position="right">
            <NavLink
              to="/admin/analytics"
              className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}
              end
